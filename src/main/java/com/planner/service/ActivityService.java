...
// Corresponds to UC2 (Create Activity) and UC3 (Add Developer to Activity) from Report 1.
// Depends on interfaces (not concrete classes) — Dependency Inversion Principle (Report 2, Section 6.4).
...
public class ActivityService {
    ...
    // UC2: Create Activity (Report 1, Section 4.2)
    ...
    // UC2: Set Activity Details (Report 1, Section 4.2)
    ...
    // Systematically tested in Report 2, Section 3.3 (equivalence partitioning + boundary value analysis).
    ...
    public void setActivityDetails(String projectId, String activityName,
        ...
        // Pre-conditions (Design by Contract, Report 2 Section 4.2):
    ...
    // UC3: Add Developer to Activity (Report 1, Section 4.3)

...
// Covers UC6 (Register Absence) from Report 1, Section 4.6.
// Systematically tested in Report 2, Section 3.6 using equivalence partitioning.
// Key business rule: sick leave (SICK_LEAVE) is always allowed even if the developer
// is assigned to an activity — all other absence types are denied in that case.
...
public class AbsenceServiceTest {
    ...
    // sick leave must be allowed (you cannot refuse someone calling in sick)
    @Test
